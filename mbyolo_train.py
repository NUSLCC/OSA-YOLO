...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/chenchen/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-11.yaml', help='model path(s)')
