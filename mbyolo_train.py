...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/chenchen/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-Omni.yaml', help='model path(s)')
    ...
    parser.add_argument('--workers', type=int, default=48, help='max dataloader workers (per RANK in DDP mode)')
    parser.add_argument('--optimizer', default='SGD', help='SGD, Adam, AdamW')
    parser.add_argument('--amp', action='store_true', help='open amp')
    parser.add_argument('--project', default='/home/chenchen/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo12_omni', help='save to project/name')
    parser.add_argument('--name', default='mambayolo12_sscore', help='save to project/name')
