...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/chenchen/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-Zig.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo_zigzag', help='save to project/name')
    parser.add_argument('--name', default='mambayolo_zigzag_2442_4tb', help='save to project/name')
