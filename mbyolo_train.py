...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='/home/lcc/UAVGIT/helipad/data.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO/output_dir/heli', help='save to project/name')
