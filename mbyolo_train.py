...
task_name = 'mambayolo_omni_2442_a2c2faddcentral_aug180'
...
def parse_opt():
    ...
    # Training settings
    parser.add_argument('--model', type=str, default=current_path+'/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-Omni-A2C2F-Mid.yaml', help='model path(s)')
