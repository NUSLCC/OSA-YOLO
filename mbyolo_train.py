...
def parse_opt():
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo_cbam', help='save to project/name')
    parser.add_argument('--name', default='mambayolo12_cbam_0.1', help='save to project/name')
