...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/lcc/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-Zig.yaml', help='model path(s)')
    ...
    parser.add_argument('--name', default='mambayolo_zigzag_2442_vmamba', help='save to project/name')
