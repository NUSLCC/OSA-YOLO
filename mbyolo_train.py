...
task_name = 'mambayolo_omni_2442_c2psa_aug180'
...
def parse_opt():
    ...
    # Training settings
    parser.add_argument('--model', type=str, default=current_path+'/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-C2PSA-Omni.yaml', help='model path(s)')
