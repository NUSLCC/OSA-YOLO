...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/lcc/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-hybrid.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo12_test', help='save to project/name')
    parser.add_argument('--name', default='mambayolo12_hybrid', help='save to project/name')
