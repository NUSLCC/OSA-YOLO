...
def parse_opt():
    ...
    parser.add_argument('--project', default='/home/chenchen/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo_plain', help='save to project/name')
    parser.add_argument('--name', default='mambayolo_plain_2442', help='save to project/name')
