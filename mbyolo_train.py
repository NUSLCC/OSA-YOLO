...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/lcc/UAVGIT/GitRepo/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/GitRepo/Mamba-YOLO-11/output_dir/mamba_yolo_ss2d', help='save to project/name')
    parser.add_argument('--name', default='mambayolo12_ss2d_2244_vim', help='save to project/name')
