...
def parse_opt():
    ...
    parser.add_argument('--project', default='/home/chenchen/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo_zig', help='save to project/name')
    parser.add_argument('--name', default='mambayolo_zig_2442_4lr', help='save to project/name')
