...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/chenchen/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-12-21l.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/chenchen/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo12', help='save to project/name')
