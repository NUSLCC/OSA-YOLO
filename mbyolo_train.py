...
import argparse
# import sys
# sys.path.append('/home/lcc/UAVGIT/Mamba-YOLO-11')
...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default='/home/lcc/UAVGIT/Mamba-YOLO-11/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-12-20l.yaml', help='model path(s)')
    parser.add_argument('--batch_size', type=int, default=8, help='batch size')
    parser.add_argument('--imgsz', '--img', '--img-size', type=int, default=640, help='inference size (pixels)')
    parser.add_argument('--task', default='train', help='train, val, test, speed or study')
    parser.add_argument('--device', default=[0,1,2,3], help='cuda device, i.e. 0 or 0,1 or cpu')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO-11/output_dir/mamba_yolo12', help='save to project/name')
    parser.add_argument('--name', default='mambayolo12', help='save to project/name')
