...
task_name = 'mambayolo_omni_3663_mixed_aug180'
...
def parse_opt():
    ...
    # Training settings
    parser.add_argument('--model', type=str, default=current_path+'/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T-Omni-Mixed.yaml', help='model path(s)')
    ...
    parser.add_argument('--batch', type=int, default=70, help='batch size')
