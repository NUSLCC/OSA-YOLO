...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='/home/lcc/UAVGIT/Mamba-YOLO/ultralytics/cfg/datasets/VisDrone.yaml', help='dataset.yaml path')
    parser.add_argument('--config', type=str, default='/home/lcc/UAVGIT/Mamba-YOLO/ultralytics/cfg/models/mamba-yolo/Mamba-YOLO-T.yaml', help='model path(s)')
    ...
    parser.add_argument('--project', default='/home/lcc/UAVGIT/Mamba-YOLO/output_dir/visdrone', help='save to project/name')
